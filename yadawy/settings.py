"""
Django settings for yadawy project.
...
SECRET_KEY = 'django-insecure-42pl%%_uw5eeq-)vg))q*t^9apy*tdzi65c*sc)*hz-x$)k1na'
...
WSGI_APPLICATION = 'yadawy.wsgi.application'
